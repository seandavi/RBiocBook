...
gives a *right* one, so smoothly that you never build the skill yourself (see @fig-ai-skill-timing). It is
...
![Optimal timing of AI usage that can enhance expert work while reducing the chances of de-skilling and never-skilling. Reproduced from Abdulnour, Gin, and Boscardin [@pmid:40834302].](images/ai-skilling-timing.jpg){#fig-ai-skill-timing}
