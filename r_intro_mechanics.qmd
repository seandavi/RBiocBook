...
R is available for Windows, Mac, and Linux. To install R, go to the
[Comprehensive R Archive Network (CRAN)](https://cran.r-project.org/).
Click on the download link for your operating system and follow the
instructions.  

## Installing RStudio

RStudio is an Integrated Development Environment (IDE) for R. It is
available for Windows, Mac, and Linux. To install RStudio, go to the
