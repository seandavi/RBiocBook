...
The idea is that one learns faster and better by developing "schemata" that
allow us to organize and understand new information. This is a concept from
cognitive psychology known as Schema Theory [@author_schema_2016]. The idea is that
we build on our prior knowledge and experiences to create mental models that
help us understand new information. This is particularly important for adult
learners, who often have a wealth of experience and knowledge that can be
leveraged to learn new concepts.


![Schema theory of learning. While probably not entirely applicable to how adults learn, it does highlight the importance of building on prior knowledge.](images/schema_theory.png){#fig-schema-theory}
