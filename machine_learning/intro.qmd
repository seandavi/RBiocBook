...
![A simple view of machine learning according to scikit-learn. Source: the scikit-learn machine-learning map (`ml_map`), © the scikit-learn developers, [BSD 3-Clause](https://github.com/scikit-learn/scikit-learn/blob/main/COPYING).](../images/sklearn-ml-overview.png){#fig-sklearn}
