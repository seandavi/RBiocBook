...
# GenomicRanges (and GenomeInfoDb, which it loads) give us the GRanges tools used
# throughout this chapter: seqnames(), width(), seqlevels(), seqlevelsStyle(), and
# the overlap/resize operators.
