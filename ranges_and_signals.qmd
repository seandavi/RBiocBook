...
If you have your own bed files, you can use the `rtracklayer` package to import the bed files to GRanges objects to perform the same analyses we are doing here.
