...
>
> [![The Terminal tab in RStudio. Screenshot © Posit Software, PBC; shown for identification only, no endorsement implied.](https://docs.posit.co/ide/user/ide/guide/tools/images/terminal-basic.png)](https://docs.posit.co/ide/user/ide/guide/tools/images/terminal-basic.png "The Terminal tab in RStudio. Screenshot © Posit Software, PBC; shown for identification only, no endorsement implied.")
>
> The Terminal tab in RStudio. Screenshot © Posit Software, PBC; shown for identification only, no endorsement implied.
>
...
For a visual overview of how Git works and the handful of commands that drive it, [this short video](https://youtu.be/e9lnsKot_SQ) is a helpful primer before we start.
