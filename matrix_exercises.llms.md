...
- Use the [`hist()`](https://rdrr.io/r/graphics/hist.html) function to look at the distribution of all the monthly sunspot data.

``` downlit
hist(sunspot_mat)
```

- Read about the `breaks` argument to [`hist()`](https://rdrr.io/r/graphics/hist.html) to try to increase the number of breaks in the histogram to increase the resolution slightly. Adjust your [`hist()`](https://rdrr.io/r/graphics/hist.html) and breaks to your liking.
